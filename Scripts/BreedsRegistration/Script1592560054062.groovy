...
WebUI.setText(findTestObject('Object Repository/Breeds/Page_LIMS  Log in/input_v10_InputUserName'), 'qcstdev')

WebUI.setEncryptedText(findTestObject('Object Repository/Breeds/Page_LIMS  Log in/input_v10_InputPassword'), 'rXz5fG76N1x/0XfTppooEQ==')

WebUI.click(findTestObject('Object Repository/Breeds/Page_LIMS  Log in/button_Sign In'))

WebUI.maximizeWindow()

WebUI.click(findTestObject('Object Repository/Breeds/Page_LIMS/p_Setup'))

WebUI.click(findTestObject('Object Repository/Breeds/Page_LIMS/a_Breeds'))
