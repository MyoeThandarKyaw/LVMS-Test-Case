...
WebUI.setText(findTestObject('Object Repository/Person/Page_LIMS/input_84'), 'Daw Myat Theingi Ko')
...
WebUI.setText(findTestObject('Object Repository/Person/Page_LIMS/input_0'), '၈၂၇၄၆၈')
